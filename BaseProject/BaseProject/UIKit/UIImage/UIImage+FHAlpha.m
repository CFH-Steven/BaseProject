...
- (CGImageRef)fh_newBorderMask:(NSUInteger)borderSize size:(CGSize)size;
@end


@implementation UIImage (FHAlpha)
...
- (UIImage *)fh_transparentBorderImage:(NSUInteger)borderSize {
    ...
    CGImageRef maskImageRef = [self fh_newBorderMask:borderSize size:newRect.size];
