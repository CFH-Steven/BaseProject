...
#import "UIView+FHVisuals.h"

// Degree -> Rad
#define degToRad(x) (M_PI * (x) / 180.0)

@implementation UIView (FHVisuals)
...
/** 从父视图动画消失 */
-(void)fh_removeFromSuperviewWithFadeDuration:(NSTimeInterval)duration completion:(void (^ __nullable)(BOOL finished))completion{
