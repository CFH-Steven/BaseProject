...
//  Copyright © 2018年 QiDong. All rights reserved.
//
...
#define kPFBoldFont(a) [UIFont fontWithName:@"PingFang-SC-Bold" size:a*ScaleWidth]
#define kPFMediumFont(a) [UIFont fontWithName:@"PingFang-SC-Medium" size:a*ScaleWidth]
...
//主题色
#define ThemeColor [UIColor colorWithHexString:@"0xFFA30F"]
#define ThemeGrayColor [UIColor colorWithHexString:@"0x666666"]
#define ThemeVCBackgroundColor [UIColor colorWithHexString:@"0xF7F7F7"]
#define ThemeTabbarColor [UIColor colorWithHexString:@"0xFAFAFA"]
...
#define kfffbfb [UIColor colorWithHexString:@"0xfffbfb"]
#define k7aadf5 [UIColor colorWithHexString:@"0x7aadf5"]
#define kededed [UIColor colorWithHexString:@"0xededed"]
#define k7CAEF2 [UIColor colorWithHexString:@"0x7CAEF2"]

/*
 时间
 */
//请求返回提示信息显示时间
#define ResponseShowTipTimer 3
