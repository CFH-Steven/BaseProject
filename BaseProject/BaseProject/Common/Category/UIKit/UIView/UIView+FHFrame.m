...
- (void)fh_moveOriginToPoint:(CGPoint)point{
    CGRect newframe = self.frame;
...
- (void)fh_scaleWidth:(CGFloat)widthFactor height:(CGFloat)heightFactor{
    CGRect newframe = self.frame;
...
- (void)fh_fitScaleInSize:(CGSize)size{
