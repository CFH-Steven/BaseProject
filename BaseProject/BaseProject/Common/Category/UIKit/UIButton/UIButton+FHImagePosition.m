...
@implementation UIButton (FHImagePosition)
...
- (void)fh_setImagePosition:(FHButtomImagePosition)postion spacing:(CGFloat)spacing{
    ...
    switch (postion) {
        case FHButtomImagePositionLeft:
        ...
        case FHButtomImagePositionRight:
        ...
        case FHButtomImagePositionBottom:
            self.imageEdgeInsets = UIEdgeInsetsMake(imageOffsetY, imageOffsetX, -imageOffsetY, -imageOffsetX);
            self.titleEdgeInsets = UIEdgeInsetsMake(-labelOffsetY, -labelOffsetX, labelOffsetY, labelOffsetX);
