...
- (CYLTabBarController *)tabBarController {
    if (_tabBarController == nil) {
        ...
        UIOffset titlePositionAdjustment = UIOffsetMake(0, -4);
        if (CYL_IS_IPHONE_X) {
            imageInsets = UIEdgeInsetsMake(8, 0, -8, 0);
            titlePositionAdjustment = UIOffsetMake(0, 16);
        }
...
- (NSArray *)viewControllers {
    BaseHomeViewController *homeViewController = [[BaseHomeViewController alloc] init];
    BBNavigationController *homeNavigationController = [[BBNavigationController alloc]
                                                   initWithRootViewController:homeViewController];

    BaseMeViewController *meViewController = [[BaseMeViewController alloc] init];
    BBNavigationController *meNavigationController = [[BBNavigationController alloc]
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *homeTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : @"tab_icon_news",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"tab_icon_news_pr", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *meTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"我的",
                                                  CYLTabBarItemImage : @"tab_icon_communication",
                                                  CYLTabBarItemSelectedImage : @"tab_icon_communication_pre",
                                                  };
...
#warning CUSTOMIZE YOUR TABBAR APPEARANCE
    ...
    normalAttrs[NSForegroundColorAttributeName] = ThemeGrayColor;
    ...
    [[UITabBar appearance] setBackgroundColor:ThemeTabbarColor];
